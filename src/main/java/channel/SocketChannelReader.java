...
/**
 * @program: JDK
 * @description: 类SocketChannelReader使用SocketChannel来下载特定网页的HTML内容。
 * @author: soulx
 * http://blog.sae.sina.com.cn/archives/2398
 * @create: 2020-04-17 09:11
 **/
...
public class SocketChannelReader {
    ...
    private void connect() throws IOException {//连接到CSDN
        InetSocketAddress socketAddress =
                new InetSocketAddress("www.blog.csdn.net", 443 );
